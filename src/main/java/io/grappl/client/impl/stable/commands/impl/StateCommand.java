...
public class StateCommand implements Command {
    ...
    public void runCommand(ApplicationState state, String[] args) {
        if(state.getFocusedGrappl() == null) {
            ...
            Application.getLog().log(state.getFocusedGrappl().getInternalServer().getAddress() + " internal server");
            Application.getLog().log(state.getFocusedGrappl().getInternalServer().getPort() + " internal port");
        }
    }
}
